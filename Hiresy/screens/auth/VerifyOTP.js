    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <Text style={styles.formDescription}>
          Please enter your email OTP to send confirmation regarding your password change.
        </Text>
        ...
        >
          <Text style={styles.confirmButtonText} onPress={() => navigation.navigate('Login')} >Confirm OTP</Text>
        </TouchableOpacity>
