...
const MapScreen = () => {
  ...
  const markers = [
    ...
    { id: 3, coordinate: { latitude: 3.87, longitude: 11.51 }, type: "job" }, // Biyem-Assi
    { id: 4, coordinate: { latitude: 3.84, longitude: 11.49 }, type: "job" }, // Bastos
    { id: 5, coordinate: { latitude: 3.83, longitude: 11.51 }, type: "job" }, // Nsam
    { id: 6, coordinate: { latitude: 3.81, longitude: 11.52 }, type: "job" }, // Ekounou
    { id: 7, coordinate: { latitude: 3.8, longitude: 11.5 }, type: "user" }, // User Location
  ];
      ...
      >
        {markers.map((marker) => (
          <Marker key={marker.id} coordinate={marker.coordinate}>
            ...
            {marker.type === "user" && <View style={styles.userLocationRing} />}
          </Marker>
        ))}
      </MapView>
